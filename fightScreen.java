...
//		s.setVisible(true);
	...
	public fightScreen(SelectSkillPortion menu, String monstertype) {
...
//						}
	...
	public void setting() {
		...
		back = new JLabel(new ImageIcon(
				"/Users/silver/Documents/knu_term_0201/Java Programming/eclipse-workspace/Project/스크린샷 2021-05-30 오전 3.48.29.png"));
		setLayout(null);
		setContentPane(back);
		...
		mHP = new monsterHP(2000);
		pHP = new playerHP(2000, 20, m.getGrade());
	...
	public int randomdamage() {
		...
		damage = (int) ((Math.random() * 250 - 150)) + 150;
		plus = random + damage;
		return plus;
	}
	...
	public int randommonster() {
		...
		damage = (int) ((Math.random() * 300 - 100)) + 100;
	...
	public int randomheal() {
		...
		heal = (int) ((Math.random() * 100 - 50)) + 50;
